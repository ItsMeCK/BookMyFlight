class PassengerBookingsController < ApplicationController
  before_action :set_passenger_booking, only: [:show, :edit, :update, :destroy]

  # GET /passenger_bookings
  # GET /passenger_bookings.json
  def index
    @passenger_bookings = PassengerBooking.all
  end

  # GET /passenger_bookings/1
  # GET /passenger_bookings/1.json
  def show
  end
  ...
  # POST /passenger_bookings
  # POST /passenger_bookings.json
  def create
    @passenger_booking = PassengerBooking.new(passenger_booking_params)

    respond_to do |format|
      if @passenger_booking.save
        format.html { redirect_to @passenger_booking, notice: 'Passenger booking was successfully created.' }
  ...
  # PATCH/PUT /passenger_bookings/1
  # PATCH/PUT /passenger_bookings/1.json
  def update
    respond_to do |format|
      if @passenger_booking.update(passenger_booking_params)
        format.html { redirect_to @passenger_booking, notice: 'Passenger booking was successfully updated.' }
  ...
  # DELETE /passenger_bookings/1
  # DELETE /passenger_bookings/1.json
  def destroy
  ...
  private
    ...
    def passenger_booking_params
      params.require(:passenger_booking).permit(:passenger_id, :booking_id)
    end
end
